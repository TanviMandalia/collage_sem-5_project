...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $size = isset($_POST['size']) && in_array($_POST['size'], ['Small','Medium','Large']) ? $_POST['size'] : NULL;
          ...
          <div class="card card-warning">
            ...
            <form method="POST" enctype="multipart/form-data">
              ...
              <div class="card-footer">
                ...
                <a href="product_list.php" class="btn btn-secondary float-right">Back to List</a>
              </div>
            </form>
          </div>
        </div>
